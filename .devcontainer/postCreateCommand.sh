...
bundle exec rails new . -f -B -d postgresql  -a propshaft -c tailwind --skip-action-mailer --skip-action-mailbox --skip-action-text --skip-action-cable --skip-aciton-storage --skip-ci --skip-docker
# cat <<EOF >> Gemfile
# gem "rails-i18n"
